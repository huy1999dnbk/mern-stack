...
const getProducts = async (req, res, next) => {
  try {
    ...
    //get product from search main page
    ...
    //get product from filter option in product list page(can include multiple category separated by comma)
    ...
    //pass to mongodb method using operator
    if (queryCondition) {
      query = {
        $and: [
          priceQueryCondition,
